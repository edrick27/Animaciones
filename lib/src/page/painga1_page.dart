import 'package:animate_example/src/page/navegacion_page.dart';
import 'package:animate_example/src/page/twitter_page.dart';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => TwitterPage()))
          ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FadeInDown(
              ...
              child: Text('Soy un texto pequeño', style: TextStyle(fontSize:  20, fontWeight: FontWeight.w200))
            ),
